use super::{noise::Noise, validatable::Validatable};
...
impl Terrain {
    ...
    pub fn generate_noise_map(&self) -> Option<Vec<Vec<f64>>> {
        ...
        let octave_offsets: Vec<(f64, f64)> = (0..self.noise.num_octaves)
            .map(|_| {
        ...
        for y in 0..self.height {
            for x in 0..self.width {
                ...
                for idx_octave in 0..self.noise.num_octaves {
                    let sample_x =
                    ...
                    amplitude *= self.noise.persistance as f64;
                    frequency *= self.noise.lacunarity as f64;
                }
